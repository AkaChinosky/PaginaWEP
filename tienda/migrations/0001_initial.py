    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(choices=[('H', 'Hombre'), ('M', 'Mujer')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unidades_por_talla', models.JSONField()),
                ('seccion', models.CharField(choices=[('Hombres', 'Hombres'), ('Mujeres', 'Mujeres'), ('Accesorios', 'Accesorios')], max_length=20)),
        ...
        migrations.AddField(
            ...
            name='favorite_items',
            field=models.ManyToManyField(related_name='favorited_by', to='tienda.producto'),
        ),
    ]
